 ...
 * @author JUAN CAMILO
 */
public class mediaC1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        desviacionP = new javax.swing.JTextField();
        ...
        setTitle("Intervalos  de confianza para la media caso1:\n");

        jLabel1.setText("Tamaño de la muestra mayor o igual a 30  y Varianza poblacional conocida");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel2.setText("Intervalos  de confianza para la media caso 1:");
        ...
        jLabel4.setText("Ingrese el valor de la desviacion estandart poblacional:");

        desviacionP.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                desviacionPKeyTyped(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(desviacionP, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jLabel4)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(desviacionP, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jLabel5)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        try {
            ...
            if ((MediaM.getText().length() == 0) || (desviacionP.getText().length() == 0) || (n.getText().length() == 0)) {
                //emite señal de error
                getToolkit().beep();
                JOptionPane.showMessageDialog(this, "Ingrese el valor de la media muestral, la distribucion estandar poblacional  y el tamaño del muestra para poder hallar el intervalo de confianza", "Error de Campo vacio", JOptionPane.ERROR_MESSAGE);

            } else if (Double.parseDouble(n.getText()) < 30) {
                //emite señal de error
                getToolkit().beep();
                JOptionPane.showMessageDialog(this, "el tamaño de la muestra deve ser mayor o igual a 30", "Tamaño de la muestra no valido", JOptionPane.ERROR_MESSAGE);

            } else {

                //DecimalFormat df = new DecimalFormat("0.00000");
                media = Double.parseDouble(MediaM.getText());
                deviacion = Double.parseDouble(desviacionP.getText());
                ...
                if ((nivelc > 100) || (nivelc < 0)) {
                    ...
                    sup = media + (outcomeRisk * (deviacion / Math.sqrt(tamaño)));
                    inf = media - (outcomeRisk * (deviacion / Math.sqrt(tamaño)));
    ...
    private void desviacionPKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_desviacionPKeyTyped
        //declaro unba variable de tipo char y le digo que me devuelva solo los valores que le diga que me retorne
        char c = evt.getKeyChar();
        //si el char es una letra
        if (Character.isLetter(c)) {
    ...
    }//GEN-LAST:event_desviacionPKeyTyped
    ...
    private javax.swing.JTextField desviacionP;
