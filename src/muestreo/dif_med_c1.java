 ...
 * @author JUAN CAMILO
 */
public class dif_med_c1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        varianzaP1 = new javax.swing.JTextField();
        ...
        varianzaP2 = new javax.swing.JTextField();
        ...
        setTitle("Intervalos de confianza para la diferencia de medias caso 1:\n");

        jLabel1.setText("Varianzas poblacionales conocidas:");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setText("Intervalos  de confianza para la diferencia de medias caso 1:");
        ...
        jLabel4.setText("Ingrese el valor de las varianzas poblacionales:");

        varianzaP1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                varianzaP1KeyTyped(evt);
            }
        });
        ...
        jLabel12.setText("σ1^2 =");

        varianzaP2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                varianzaP2KeyTyped(evt);
            }
        });

        jLabel13.setText("σ2^2 =");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(varianzaP1, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(jLabel13)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(varianzaP2, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(varianzaP1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel12))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(varianzaP2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel13))
                .addGap(2, 2, 2)
                .addComponent(jLabel5)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        x1.setText(null);
        x2.setText(null);
        varianzaP1.setText(null);
        varianzaP2.setText(null);
        n1.setText(null);
        n2.setText(null);
        nc.setText(null);
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        try {
            ...
            if ((x1.getText().length() == 0) || (x2.getText().length() == 0) || (varianzaP1.getText().length() == 0) || (varianzaP2.getText().length() == 0) || (n1.getText().length() == 0) || (n2.getText().length() == 0)) {
                ...
                varianza1 = Double.parseDouble(varianzaP1.getText());
                varianza2 = Double.parseDouble(varianzaP2.getText());
                ...
                if ((nivelc > 100) || (nivelc < 0)) {
                    ...
                    sup = (media1 - media2) + (outcomeRisk * (Math.sqrt((varianza1 / tamaño1) + (varianza2 / tamaño2))));
                    inf = (media1 - media2) - (outcomeRisk * (Math.sqrt((varianza1 / tamaño1) + (varianza2 / tamaño2))));
    ...
    private void varianzaP1KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_varianzaP1KeyTyped
        //declaro unba variable de tipo char y le digo que me devuelva solo los valores que le diga que me retorne
        char c = evt.getKeyChar();
        //si el char es una letra
        if (Character.isLetter(c)) {
    ...
    }//GEN-LAST:event_varianzaP1KeyTyped
    ...
    private void varianzaP2KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_varianzaP2KeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_varianzaP2KeyTyped
    ...
    private javax.swing.JTextField varianzaP1;
    private javax.swing.JTextField varianzaP2;
