 ...
 * @author JUAN CAMILO
 */
public class Estratificado extends javax.swing.JFrame {
     ...
     */
    public Estratificado(ArrayList datos, ArrayList estratos, int tamañoMuestra, int cantidad) {
        initComponents();
        ...
        if (this.muestra.isEmpty()) {
            ...
            for (int i = 0; i < this.estratos.size(); i++) {
                ...
                while (contador <= tamañoMuestra) {
                    ...
                    e = (int) (Math.random() * this.estratos.get(i).getDatos().size());
